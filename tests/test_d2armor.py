...
class TestOutfits(unittest.TestCase):
    ...
    def test_generate_class_outfits(self):
        ...
        self.assertEqual(outfits[1], (30, 50, 40, 60, 30, 30, self.exotic_helmet.instance_id, self.gauntlets.instance_id, self.chest_armor.instance_id, self.leg_armor.instance_id, self.class_item.instance_id, self.exotic_helmet.item_hash, 0))
        self.assertEqual(outfits[2], (40, 40, 40, 40, 40, 40, self.exotic_helmet2.instance_id, self.gauntlets.instance_id, self.chest_armor.instance_id, self.leg_armor.instance_id, self.class_item.instance_id, self.exotic_helmet2.item_hash, 0))
    ...
    def test_outfit_permutations_one_artifice_stats_seven(self):
        ...
        artifice_helmet_7 = Armor(slot="Helmet", mobility=7, resilience=7, recovery=7, discipline=7, intellect=7, strength=7, is_artifice=True)
        one_artifice_armor_dict = self.armor_list_to_dict([artifice_helmet_7, self.gauntlets_0, self.chest_armor_0, self.leg_armor_0, self.class_item_0])

        profile_outfits = ProfileOutfits(one_artifice_armor_dict)
        outfits = profile_outfits.generate_class_outfits("Warlock")
        self.assertEqual(len(outfits), 6)
        self.assertIn((20, 10, 10, 10, 10, 10, artifice_helmet_7.instance_id, self.gauntlets_0.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 1), outfits)
        self.assertIn((10, 20, 10, 10, 10, 10, artifice_helmet_7.instance_id, self.gauntlets_0.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 1), outfits)
        self.assertIn((10, 10, 20, 10, 10, 10, artifice_helmet_7.instance_id, self.gauntlets_0.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 1), outfits)
        self.assertIn((10, 10, 10, 20, 10, 10, artifice_helmet_7.instance_id, self.gauntlets_0.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 1), outfits)
        self.assertIn((10, 10, 10, 10, 20, 10, artifice_helmet_7.instance_id, self.gauntlets_0.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 1), outfits)
        self.assertIn((10, 10, 10, 10, 10, 20, artifice_helmet_7.instance_id, self.gauntlets_0.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 1), outfits)
    ...
    def test_outfit_permutations_two_artifice_stats_four(self):
        ...
        artifice_helmet_0 = Armor(slot="Helmet", is_artifice=True) # all stats still at zero
        artifice_gauntlets_4 = Armor(slot="Gauntlets", mobility=4, resilience=4, recovery=4, discipline=4, intellect=4, strength=4, is_artifice=True)

        two_artifice_armor_dict = self.armor_list_to_dict([artifice_helmet_0, artifice_gauntlets_4, self.chest_armor_0, self.leg_armor_0, self.class_item_0])

        profile_outfits = ProfileOutfits(two_artifice_armor_dict)
        outfits = profile_outfits.generate_class_outfits("Warlock")
        self.assertEqual(len(outfits), 7)
        self.assertIn((10, 10, 10, 10, 10, 10, artifice_helmet_0.instance_id, artifice_gauntlets_4.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 2), outfits)
        self.assertIn((20, 10, 10, 10, 10, 10, artifice_helmet_0.instance_id, artifice_gauntlets_4.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 2), outfits)
        self.assertIn((10, 20, 10, 10, 10, 10, artifice_helmet_0.instance_id, artifice_gauntlets_4.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 2), outfits)
        self.assertIn((10, 10, 20, 10, 10, 10, artifice_helmet_0.instance_id, artifice_gauntlets_4.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 2), outfits)
        self.assertIn((10, 10, 10, 20, 10, 10, artifice_helmet_0.instance_id, artifice_gauntlets_4.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 2), outfits)
        self.assertIn((10, 10, 10, 10, 20, 10, artifice_helmet_0.instance_id, artifice_gauntlets_4.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 2), outfits)
        self.assertIn((10, 10, 10, 10, 10, 20, artifice_helmet_0.instance_id, artifice_gauntlets_4.instance_id, self.chest_armor_0.instance_id, self.leg_armor_0.instance_id, self.class_item_0.instance_id, -1, 2), outfits)
